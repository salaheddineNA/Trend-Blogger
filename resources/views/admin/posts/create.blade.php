...
<div class="container-fluid mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 fade-in-up">
        <div>
            <h2 class="fw-bold mb-1">✍️ Create New Post</h2>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                      ...
                                      placeholder="Write a brief summary..." required>{{ old('excerpt') }}</textarea>
                            <div class="char-counter" id="excerptCounter">0 / 200 characters</div>
                            @error('excerpt')
                                <div class="invalid-feedback mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                      ...
                                      placeholder="Start writing your amazing content..." required>{{ old('content') }}</textarea>
                            <div class="char-counter" id="contentCounter">0 words</div>
                            @error('content')
                                <div class="invalid-feedback mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label text-white" for="is_published">
                                <i class="bx bx-check-circle me-2"></i>Publish immediately
                            </label>
                        </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-gradient-primary">
                                <i class="bx bx-save me-2"></i> Create Post
                            </button>
